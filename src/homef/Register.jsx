...
const title = (
    <h2 className='title'>Join on Day Long Free Workshop For <b> Advance <span>Mastring</span></b> on Sales</h2>
)
    ...
    return (
        <section className='register-section padding-tb pb-0'>
            <div className='container'>
                <div className='row g-4 row-cols-lg-2 row-cols-1 align-otems-center'>
                    <div className='col'>
